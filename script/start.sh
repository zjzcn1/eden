#!/bin/sh
MAIN_CLASS="com.github.eden.Eden"
...
CLASS_PATH="$PROJECT_DIR:$PROJECT_DIR/conf:$PROJECT_DIR/lib/*:$CLASS_PATH"

#run java
mkdir -p "$PROJECT_DIR/log/"
exec java -server $MEM_OPTS $GC_OPTS $START_OPTS -cp $CLASS_PATH $MAIN_CLASS
